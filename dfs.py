...
# Here I've to use three algos to deal with this problem 
# 1. Graph algorithm 2. stack algorithm 3. Main

from cProfile import label
from stack import Stack
#let's start building graph class
class Graph: 
    def __init__(self):
        self.vertices:list = []
